# MCP Atlassian Server - Vibe-Coded Edition
...
4. Copy the token and paste it into your config
...
- **[Quick Reference](./docs/quick-reference.md)** - All 32 tools with examples
- **[Architecture Guide](./docs/architecture.md)** - How the code actually works
- **[API Reference](./docs/api-reference.md)** - Complete tools & resources list
- **[Old README](./README_OLD.md)** - Original proper documentation
...
Same as the original project. Check LICENSE file.

 ...
 */
export function isAtlassianCloudUrl(url) {
 ...
 */
export function getDeploymentType(url) {
 ...
 */
function isLocalOrPrivateAddress(hostname) {
    // Check for localhost
 ...
 */
function isAtlassianCloudDomain(hostname) {
 ...
 */
export function validateAtlassianUrl(url) {
    if (!url || typeof url !== 'string') {
 ...
 */
export function normalizeAtlassianUrl(url) {
